<?php
/*
 * $Id: backend_weblog.php,v 1.4 2006/03/22 09:57:17 mikhail Exp $
...
foreach ($results as $entryObject) {
    $item['title'] = htmlspecialchars(encoding_set($entryObject->getVar('title', 'e'), 'UTF-8'), ENT_QUOTES | ENT_HTML5);
