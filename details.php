<?php
/**
 * $Id: details.php,v 1.4 2006/03/22 09:57:17 mikhail Exp $
...
// specify template
$GLOBALS['xoopsOption']['template_main'] = 'weblog' . $mydirnumber . '_details.html';
...
// (ex. IIS)
if ((isset($_SERVER['SERVER_SOFTWARE']) && false !== stripos($_SERVER['SERVER_SOFTWARE'], "Microsoft-IIS")) || !isset($_SERVER['REQUEST_URI'])) {
    $delimiter = '?';
} else {
    $delimiter = '/';
}
...
$_GET['user_id'] = $entryObject->getVar('user_id');
