...
if (!defined('DATE_CALC_BEGIN_WEEKDAY')) {
    ...
    class Date_Calc
    {
        ...
        public function nextWeekday($day = '', $month = '', $year = '', $format = '%Y%m%d')
        {
            ...
            if (5 == self::dayOfWeek($day, $month, $year)) {
                $days += 3;
            } elseif (6 == self::dayOfWeek($day, $month, $year)) {
                $days += 2;
            } else {
                $days += 1;
            }
        ...
        public function prevWeekday($day = '', $month = '', $year = '', $format = '%Y%m%d')
        {
            ...
            if (1 == self::dayOfWeek($day, $month, $year)) {
                $days -= 3;
            } elseif (0 == self::dayOfWeek($day, $month, $year)) {
                $days -= 2;
            } else {
                $days -= 1;
            }
         ...
         * @param mixed $year
         * @param mixed $format
         * @param mixed $onOrAfter
         *
         *
         * @return string date in given format
         */
        public function nextDayOfWeek($dow, $day = '', $month = '', $year = '', $format = '%Y%m%d', $onOrAfter = false)
        {
            if (empty($year)) {
                $year = self::dateNow('%Y');
            }
         ...
         * @param mixed $year
         * @param mixed $format
         * @param mixed $onOrBefore
         *
         *
         * @return string date in given format
         */
        public function prevDayOfWeek($dow, $day = '', $month = '', $year = '', $format = '%Y%m%d', $onOrBefore = false)
        {
            if (empty($year)) {
                $year = self::dateNow('%Y');
            }
        ...
        public function dateDiff($day1, $month1, $year1, $day2, $month2, $year2)
        {
            ...
            return (abs(
                (self::dateToDays($day1, $month1, $year1)) - (self::dateToDays($day2, $month2, $year2))
            ));
        }
        ...
        public function daysInMonth($month = '', $year = '')
        {
            ...
            if (2 == $month) {
                ...
                return 28;
            } elseif (4 == $month or 6 == $month or 9 == $month or 11 == $month) {
                return 30;
            }
        ...
        public function weeksInMonth($month = '', $year = '')
        {
            ...
            if (DATE_CALC_BEGIN_WEEKDAY == 1 && 0 == $FDOM) {
                $first_week_days = 7 - $FDOM + DATE_CALC_BEGIN_WEEKDAY;

                $weeks = 1;
            } elseif (DATE_CALC_BEGIN_WEEKDAY == 0 && 6 == $FDOM) {
                $first_week_days = 7 - $FDOM + DATE_CALC_BEGIN_WEEKDAY;
         ...
         */
        public function firstOfMonthWeekday($month = '', $year = '')
        {
            if (empty($year)) {
                $year = self::dateNow('%Y');
            }
        ...
        public function beginOfNextWeek($day = '', $month = '', $year = '', $format = '%Y%m%d')
        {
            ...
            $next_week_year = mb_substr($date, 0, 4);

            $next_week_month = mb_substr($date, 4, 2);

            $next_week_day = mb_substr($date, 6, 2);

            return self::beginOfWeek(
                $next_week_day,
                $next_week_month,
                $next_week_year,
                $format
        ...
        public function beginOfPrevWeek($day = '', $month = '', $year = '', $format = '%Y%m%d')
        {
            ...
            $prev_week_year = mb_substr($date, 0, 4);

            $prev_week_month = mb_substr($date, 4, 2);

            $prev_week_day = mb_substr($date, 6, 2);
        ...
        public function getCalendarMonth($month = '', $year = '', $format = '%Y%m%d')
        {
            ...
            if (DATE_CALC_BEGIN_WEEKDAY == 1) {
                if (0 == self::firstOfMonthWeekday($month, $year)) {
        ...
        {
            $century = (int)mb_substr($year, 0, 2);

            $year = (int)mb_substr($year, 2, 2);
        ...
        public function dateFormat($day, $month, $year, $format)
        {
            ...
            for ($strpos = 0, $strposMax = mb_strlen($format); $strpos < $strposMax; $strpos++) {
                $char = mb_substr($format, $strpos, 1);

                if ('%' == $char) {
                    $nextchar = mb_substr($format, $strpos + 1, 1);
        ...
        public function getMonthAbbrname($month, $length = 3)
        {
            ...
            return mb_substr(self::getMonthFullname($month), 0, $length);
        }
        ...
        public function getWeekdayAbbrname($day = '', $month = '', $year = '', $length = 3)
        {
            ...
            return mb_substr(self::getWeekdayFullname($day, $month, $year), 0, $length);
        }
        ...
        public function getMonthFromFullName($month)
        {
            ...
            while (list($id, $name) = each($months)) {
                if (preg_match($month, mb_strtolower($name))) {
                    return ($id);
                }
            }
        ...
        public function gregorianToISO($day, $month, $year)
        {
            ...
            if ($day_of_year_number <= (8 - $jan1_weekday) && $jan1_weekday > 4) {
                ...
                if (5 == $jan1_weekday || (6 == $jan1_weekday && $y_1_isleap)) {
                    $weeknumber = 53;
                } else {
                    $weeknumber = 52;
                }
