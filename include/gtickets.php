...
if (!class_exists('XoopsGTicket')) {
    ...
    class XoopsGTicket
    {
        ...
        public function getTicketHtml($salt = '', $timeout = GTICKET_DEFAULT_TIMEOUT)
        {
        ...
        public function getTicketXoopsForm($salt = '', $timeout = GTICKET_DEFAULT_TIMEOUT)
        {
        ...
        public function getTicketArray($salt = '', $timeout = GTICKET_DEFAULT_TIMEOUT)
        {
        ...
        public function getTicketParamString($salt = '', $noamp = false, $timeout = GTICKET_DEFAULT_TIMEOUT)
        {
        ...
        public function issue($salt = '', $timeout = GTICKET_DEFAULT_TIMEOUT)
        {
            // create a token
