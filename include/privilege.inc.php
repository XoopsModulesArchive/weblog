<?php
/**
 * $Id: privilege.inc.php,v 1.1 2006/03/29 05:57:12 mikhail Exp $
...
{
    public function get_globalperm($mydirname)
    {
        ...
        if (is_object($xoopsDB)) {
            ...
            [$weblog_mid] = $xoopsDB->fetchRow($rs);
    ...
    public function get_categoryperm($mydirname)
    {
        return 1;
    }
    ...
    public function weblog_read_catperm($mydirname, $cat_id = 0)
    {
        return true;
    }

    public function can_read_index($mydirname, $cat_id = 0)
    {
    ...
    public function can_read_detail($mydirname)
    {
        $global_perms = $this->get_globalperm($mydirname);
    ...
    public function weblog_edit_gperm($mydirname)
    {
    ...
    public function weblog_edit_catperm($mydirname, $cat_id = 0)
    {
        return true;
    }

    public function can_edit($mydirname, $cat_id = 0)
    {
...
class PrivilegeWeblog
{
    ...
    public function can_edit($mydirname, $cat_id = 0)
    {
        ...
        if (0 == $currentuid || (!$isAdmin && ($xoopsModuleConfig['adminonly'] || !$priv->hasPrivilege($currentUser)))) {
            return false;
        }
