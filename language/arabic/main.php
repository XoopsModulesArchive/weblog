<?php
/**
 * $Id: main.php,v 1.1 2004/10/27 15:03:16 mikhail Exp $
...
define('_BL_NUMBER_OF_READS', '%d reads');
...
define('_BL_ANON_CANNOT_POST_SORRY', 'Sorry, Only registered users can post weBLog entries.');
