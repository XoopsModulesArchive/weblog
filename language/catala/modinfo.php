<?php
/*
 * $Id: modinfo.php,v 1.1 2006/03/18 03:23:13 mikhail Exp $
 * Copyright (c) 2004 by Jeremy N. Cowgar <jc@cowgar.com>
 *
...
define('_MI_WEBLOG_ADD_NOTIFY', 'Nuevo envío');
define('_MI_WEBLOG_ADD_NOTIFYCAP', 'Notificarme cuando un nuevo envío ocurre');
define('_MI_WEBLOG_ADD_NOTIFYDSC', 'cuando un nuevo envío se produce');
...
// Config Settings
define('_MI_WEBLOG_NUMPERPAGE', 'Número de ingresos por página');
define('_MI_WEBLOG_NUMPERPAGEDSC', '');
define('_MI_WEBLOG_NUMINRECENTBLOCK', 'Número de ingresos a mostrar en el bloque de blogs recientes');
...
define('_MI_WEBLOG_MINENTRYSIZE', 'Minimo tamaño de ingreso (0=desactivar el chequeo de tamaño)');
...
define('_MI_WEBLOG_ONLYADMINDSC', 'Configurandolo en NO le permite a los usuarios registrados el publicar, configurandolo en SI, solo los administradores podrán publicar.');
