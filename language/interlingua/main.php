<?php
/*
 * $Id: main.php,v 1.1 2004/10/27 15:03:41 mikhail Exp $
...
define('_BL_MOST_RECENT', 'Los más recientes ingresos');
...
define('_BL_CONFIRM_DELETE', "¿Está seguro que desea remover el ingreso de weBLog '%s'?");
define('_BL_BLOG_DELETED', 'Selected weBLog entry was deleted');
define('_BL_BLOG_NOT_DELETED', 'El weBLog Seleccionado no ha sido borrado.¿ Permisos Insuficientes ?');
