<?php
/**
 * $Id: admin.php,v 1.2 2006/03/29 05:51:12 mikhail Exp $
...
if (defined('FOR_XOOPS_LANG_CHECKER') || !defined('WEBLOG_AM_LOADED')) {
    ...
    define(
        '_AM_WEBLOG_ADDDSC',
        'Colonna \'<b>%s</b>\' non e stata trovata nella tabella del database. Questa colonna e richiesta per la versione corrente.<br>Premi un bottone per aggiungere queste colonne alle tabelle esistenti.<br>Il Salvataggio Back Up del database e strettamente raccomandato.'
    );
