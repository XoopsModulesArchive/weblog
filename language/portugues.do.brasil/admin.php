...
/**
 * $Id: admin.php,v 1.1 2004/10/27 15:03:50 mikhail Exp $
 ...
 */
define('_AM_WEBLOG_CONFIG', $xoopsModule->name() . ' Configuração');

define('_AM_WEBLOG_PREFERENCES', _PREFERENCES);

define('_AM_WEBLOG_PREFERENCESDSC', 'Configurações Gerais.');
...
define('_AM_WEBLOG_DBMANAGER', 'Banco de Dados');

define('_AM_WEBLOG_DBMANAGERDSC', 'Database utility that is basically for updating module.');

define('_AM_WEBLOG_TABLE', 'Tabela');

define('_AM_WEBLOG_SYNCCOMMENTS', 'Sincronizar contagem de comentários');
...
define('_AM_WEBLOG_CHECKTABLE', 'Verifica estrutura das tabelas');
...
define('_AM_WEBLOG_CATMANAGER', 'Categorias');

define('_AM_WEBLOG_CATMANAGERDSC', 'Add/Modify/Delete Categories.');

define('_AM_WEBLOG_ADDCAT', 'Inclui Categoria');

define('_AM_WEBLOG_ADDMAINCAT', 'Inclui Menu Categoria');

define('_AM_WEBLOG_ADDSUBCAT', 'Inclui Sub-Categoria');

define('_AM_WEBLOG_CAT', 'Categoria');
