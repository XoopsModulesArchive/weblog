<?php
/**
 * $Id: main.php,v 1.2 2006/03/21 18:43:53 mikhail Exp $
...
// Del Start - weBlog+TrackBack ----------------------------------------------

// define('_BL_COMMENTS','Comments');

//   Del End - weBlog+TrackBack ----------------------------------------------
...
// Add Start - weBlog+TrackBack -----------------------------------------------

define('_BL_COMMENTS', 'TrackBack & Comments');
define('_BL_TRACKBACK', 'TrackBack');
define('_BL_TRACKBACKURL', 'TrackBack URL');
define('_BL_OK', 'OK');
define('_BL_NG', 'NG');
define('_BL_SENDPING', 'TrackBack URL');
define('_BL_UPDATE', 'Update');
define('_BL_UPDATEPING', 'Send of UpdatePing');

//   Add End - weBlog+TrackBack -----------------------------------------------
