...
require_once XOOPS_ROOT_PATH . '/modules/' . $mydirname . '/include/myalbum_imagemanager/include/read_configs.php';
// require_once XOOPS_ROOT_PATH."/modules/".$mydirname."/include/myalbum_imagemanager/include/get_perms.php";
require_once XOOPS_ROOT_PATH . '/modules/' . $mydirname . '/include/myalbum_imagemanager/include/functions.php';
require_once XOOPS_ROOT_PATH . '/modules/' . $mydirname . '/include/myalbum_imagemanager/include/draw_functions.php';
require_once XOOPS_ROOT_PATH . '/modules/' . $mydirname . '/include/gtickets.php';
require_once XOOPS_ROOT_PATH . '/class/xoopstree.php';
require_once XOOPS_ROOT_PATH . '/modules/' . $mydirname . '/include/myalbum_imagemanager/class/myuploader.php';
require_once XOOPS_ROOT_PATH . '/modules/' . $mydirname . '/include/myalbum_imagemanager/class/myalbum.textsanitizer.php';
...
$title_text = new XoopsFormText(_BL_ALBM_PHOTOTITLE, 'title', 50, 255, htmlspecialchars($photo['title'], ENT_QUOTES | ENT_HTML5));
...
//$desc_tarea = new XoopsFormDhtmlTextArea( _BL_ALBM_PHOTODESC , "desc_text" , htmlspecialchars( $photo['description'] ) , 10 , 50 ) ;
